...
export class PermitImageController {
  constructor(private readonly permitImageService: PermitImageService) {}

  @UseGuards(JwtAuthGuard)
  @Post()
  @UseInterceptors(AnyFilesInterceptor())
  create(
    @Param("permitId", new JoiValidationParamPipe(permitIdParamSchema))
    permit: Permit,
    ...
    return this.permitImageService.create(permit, createPermitImageDto, file);
  }
  ...
  findAll(
    ...
    return this.permitImageService.findAll(permit, query);
  }
  ...
  async update(
    ...
    return this.permitImageService.update(permitImage, updatePermitImageDto);
  }
