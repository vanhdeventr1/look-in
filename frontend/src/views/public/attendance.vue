<template>
  <SidebarLayout>
    <div
      class="h-full max-h-full overflow-hidden flex flex-col gap-3 selection:bg-[#8C352D]/20"
    >
      <div
        v-if="!isOnline"
        class="w-full shrink-0 bg-[#8C352D] text-white text-[10px] py-2 text-center font-bold animate-pulse uppercase tracking-widest rounded-xl"
      >
        Mode Offline - Beberapa fitur mungkin tidak tersedia
      </div>

      <div
        class="w-full shrink-0 bg-white border border-[#E8D5D2] rounded-2xl p-3 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3"
      >
        <div>
          <p class="text-[#8C352D]/60 text-xs font-bold uppercase">
            Absensi Karyawan
          </p>
          <h1 class="text-[#8C352D] text-xl font-black mt-1">
        ...
        <div class="flex items-center gap-2">
          <button
            v-if="deferredPrompt"
            @click="installPWA"
            class="px-3 py-2 rounded-xl bg-[#8C352D] text-white text-[10px] font-bold shadow-sm hover:bg-[#742f28] transition-all cursor-pointer"
          >
            INSTALL APP
          </button>
      ...
      <div class="relative w-full flex-1 min-h-0 flex justify-center">
        <Transition name="slide-fade" mode="out-in">
          <div
            v-if="!showDetail"
            key="camera"
            class="w-full h-full bg-white rounded-2xl overflow-hidden border border-[#E8D5D2] shadow-sm flex flex-col"
          >
            <div
              class="bg-[#8C352D] px-5 py-4 flex items-center justify-between shrink-0"
            >
              <div>
                <h3
            ...
            <div
              class="grid grid-cols-1 lg:grid-cols-[minmax(0,320px)_1fr] gap-3 p-3 bg-white flex-1 min-h-0"
            >
              <div
                class="border border-[#E8D5D2] bg-[#FFF0EE]/50 rounded-2xl p-2 relative w-full h-full min-h-0 overflow-hidden"
              >
                <div
              ...
              <div class="flex flex-col justify-between gap-3 min-h-0">
                <div class="space-y-3">
                  <div
                  ...
                  >
                    ...
                    ></span>
                    <span
                      class="text-[10px] font-bold text-green-700 uppercase"
                    >
                      Sistem Siap
                    </span>
                  </div>
                  ...
                  <div>
                    <h4 class="text-[#8C352D] text-xl font-black leading-tight">
                      Verifikasi wajah dan lokasi
                    </h4>
                    <p class="mt-1 text-sm leading-5 text-[#8C352D]/70">
                      Pastikan wajah terlihat jelas dan izin lokasi browser
                      aktif sebelum mengirim absensi.
                    </p>
                  </div>
                ...
                <button
                  ...
                  class="w-full px-6 py-3 bg-[#8C352D] text-white rounded-xl text-sm font-bold transition-all hover:bg-[#742f28] active:scale-[0.99] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-3 cursor-pointer shadow-sm"
                >
                  <Loader2Icon
                    v-if="isLocating"
                    :size="18"
          ...
          >
            <div
              class="bg-[#8C352D] px-7 py-4 flex justify-between items-center shrink-0"
            >
            ...
            <div
              class="p-4 sm:p-6 relative bg-white flex-1 min-h-0 overflow-hidden"
            >
              <div
              ...
              <div class="flex flex-col md:flex-row gap-6 mt-2 h-full min-h-0">
                <div
                  class="w-full md:w-[300px] relative rounded-2xl overflow-hidden border border-[#E8D5D2] bg-[#FFF0EE]/40 shadow-sm"
                >
                  <img
                ...
                <div class="flex-1 min-h-0">
                  <div
                    class="w-full h-[180px] rounded-2xl overflow-hidden relative mb-5 border border-[#E8D5D2] bg-[#FFF0EE]/40 shadow-sm"
                  >
                    <iframe
                      v-if="
                        attendanceData.lat && attendanceData.lng && isOnline
                      "
                      width="100%"
                      height="100%"
                      frameborder="0"
                    ...
                    >
                      ...
                      <p
                        v-if="!isOnline"
                        class="text-[10px] font-bold text-[#8C352D] uppercase mt-2"
                      >
                  ...
                  <div class="grid grid-cols-[150px_1fr] gap-y-3.5 text-[15px]">
                    ...
                    <span class="font-bold text-[#8C352D]">
                      Durasi Terlambat
                    </span>
                    <span class="text-[#2F211F]">
