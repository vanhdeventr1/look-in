<template>
  <SidebarLayout>
          ...
          <form @submit.prevent="handleCreateUser" class="space-y-5">
            ...
            <div class="space-y-2">
              ...
              <select
                ...
                class="w-full px-5 py-3 rounded-xl border border-[#E8D5D2] bg-[#FFF0EE]/30 text-[#8C352D] focus:outline-none focus:ring-2 focus:ring-[#8C352D]/20 appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http://www.w3.org/2000/svg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%238C352D%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C/polyline%3E%3C/svg%3E')] bg-[length:20px] bg-[right_1.25rem_center] bg-no-repeat cursor-pointer"
              >
    ...
    <AlertLayout v-if="isSuccessAlertOpen" class="z-[999]">
      <template #icon>
        <div
